...
int Duration = 0; // 0-65535 (millisec)
int Duty = 0; // 0-10
...
void convertChtoBin(char buf1, char buf2, char buf3, char buf4)
{
  ...
  int duration = 0;
  if((buf2 & 0x08) != 0) duration = duration + 32768;
  if((buf2 & 0x04) != 0) duration = duration + 16384;
  if((buf2 & 0x02) != 0) duration = duration + 8192;
